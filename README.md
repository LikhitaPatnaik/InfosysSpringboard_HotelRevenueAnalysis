...
Star Schema Architecture: Designed a robust data model linking Bookings (Fact) with Customers, Rooms, and Dates (Dimensions).
...
Demographic Insights: Analyzed booking patterns to reveal that Solo Travelers drive volume, while Family/Corporate guests drive duration (avg. 5.5 nights).
